var $results, INDEX_DATA={};
    ...
    // $(document).ready(function(){
    //     var category = $("#article-category").attr("category");
    //     $("a:contains("+category+")").parent("li#category-"+category).addClass("light-left");
    //     $("a:contains("+category+")").addClass("highlight");
    // })

    // $(window).scroll(function() {
    //     var dis = $("#bottom-info").offset().top - $(window).scrollTop();
